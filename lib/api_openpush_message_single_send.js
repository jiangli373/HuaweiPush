 ...
 * Examples:
 * ```
 * api.openpush_message_single_send({deviceToken:'xxxxx',message:'xxxxxx',expire_time:5*60*1000}, callback);
 * ```
 * Callback:
 *
 * - `err`, 调用失败时得到的异常
 ...
 */
exports.openpush_message_single_send = function (options, callback) {
  this.preRequest(this._openpush_message_single_send, arguments);
};

/*!
 * 单发透传及时消息未封装版本
 */
exports._openpush_message_single_send = function (options, callback) {
